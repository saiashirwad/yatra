...
export const defaultValue =
  <Col extends Column<any, any>, const V extends Col[typeof DataType]>(value: V) =>
  (c: Col) =>
...
export const minLength =
  <Col extends Column<"string" | "text", any>, const T extends number>(value: T) =>
  (c: Col) =>
...
export const references =
  <Col extends Column<any, any>, const T extends string>(table: T, column: string) =>
  (c: Col) =>
...
export const precision =
  <Col extends Column<"number" | "decimal", any>, const T extends number>(value: T) =>
  (c: Col) =>
...
export const index = <Col extends Column<any, any>>(c: Col) => extend<Col, Index>(c, Index, true);
