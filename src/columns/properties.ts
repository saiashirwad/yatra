...
export const ColumnName = Symbol.for("ColumnName");
...
export const PrimaryKey = Symbol.for("PrimaryKey");
...
export const References = Symbol.for("References");
...
export const AutoIncrement = Symbol.for("AutoIncrement");
...
export const SearchIndexed = Symbol.for("SearchIndexed");
...
export const LiteralValue = Symbol.for("LiteralValue");
export const ItemType = Symbol.for("ItemType");
export const EnumValues = Symbol.for("EnumValues");
