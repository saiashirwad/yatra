...
export type GetDefault<T> =
  T extends Default<infer V> ? V : undefined
...
export type GetMinLength<T> =
  T extends MinLength<infer V> ? V : undefined
...
export type GetMaxLength<T> =
  T extends MaxLength<infer V> ? V : undefined
...
export type GetGenerated<T> =
  T extends Generated<infer Expr> ? Expr : undefined
...
export type GetComment<T> =
  T extends Comment<infer Text> ? Text : undefined
...
export type GetPrecision<T> =
  T extends Precision<infer P> ? P : undefined
...
export type GetScale<T> =
  T extends Scale<infer S> ? S : undefined
export const scale =
  <
    Col extends Column<"number" | "decimal", any>,
    const T extends number
