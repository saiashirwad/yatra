...
// }
//
// export type QualifiedField<T extends Tableish> =
//   T extends Tableish<infer TName, infer F> ?
//     {
...
//           const alreadyJoined = ctx.joins.some(
//             join => join.target === relation.destinationTable
//           )
//
//           if (!alreadyJoined) {
//             let sourceKey = ""
...
//         Target extends TableRelations<T>[Fields[K]]["destinationTable"] ?
...
// >(field: Field, direction: Direction = "asc" as Direction) {
//   return (
//     ctx: QueryContext<
//       T,
//       State,
...
// >(relationName: RelationName, joinType: JT = "inner" as JT) {
//   return (
//     ctx: QueryContext<
//       T,
//       State,
...
//     if (!relation) {
//       throw new Error(
//         `Relation ${String(relationName)} not found on ${String(
//           ctx.table.prototype[TableName]
//         )}`
//       )
//     }
//
